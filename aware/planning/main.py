...
def nearest_observation_window(
    ...
    sunrise = site.twilight_morning_astronomical(time, which="nearest")
    sunset = site.twilight_evening_astronomical(time, which="nearest")
    ...
    if time < sunrise < sunset:
        sunset = site.twilight_evening_astronomical(sunset, which="previous")
        return sunset, sunrise

    if sunrise < sunset < time:
        sunrise = site.twilight_morning_astronomical(sunset, which="next")
        return sunset, sunrise
